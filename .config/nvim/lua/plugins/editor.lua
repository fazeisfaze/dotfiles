...

	{
		...
		},
		{
			...
			init = function()
				...
				vim.g.vimtex_indent_enabled = true -- Disable auto-indent from Vimtex
				vim.g.tex_indent_items = true -- Disable indent for enumerate
				vim.g.tex_indent_brace = true -- Disable brace indent
